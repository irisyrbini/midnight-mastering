...
export const STUDIO_OBJECTS: StudioObject[] = [
  ...
  { id: 'mic', x: 515, y: 300, width: 46, height: 46, color: '#20242c' },
  ...
  { id: 'ashtray', x: 470, y: 351, width: 34, height: 26, color: '#8892a0' },
  ...
  // Resting on the sofa seat rather than the floor — see RoomObjectModel's 'switch' case for the seat-height lift.
  { id: 'switch', x: 640, y: 950, width: 60, height: 34, color: '#5d7a86' },
  { id: 'acousticGuitar', x: 205, y: 470, width: 62, height: 156, color: '#ba8653', shape: 'guitar' },
  { id: 'electricGuitar', x: 330, y: 470, width: 58, height: 156, color: '#e9e8df', shape: 'guitar' },
